...
use KnosTx\XMultiVersion\network\XMultiVersionSessionAdapter;
use KnosTx\XMultiVersion\network\ProtocolConstants;
use KnosTx\XMultiVersion\network\Translator;
use KnosTx\XMultiVersion\session\SessionManager;
use KnosTx\XMultiVersion\task\CompressTask;
use KnosTx\XMultiVersion\task\DecompressTask;
use KnosTx\XMultiVersion\utils\Utils;
...
class EventListener implements Listener{
    ...
    public function onDataPacketReceive(DataPacketReceiveEvent $event) {
        ...
        if($packet instanceof LoginPacket) {
            ...
            Utils::forceSetProps($player, "sessionAdapter", new XMultiVersionSessionAdapter($player->getServer(), $player, $protocol));
