...
class XMultiVersionItemTranslator{
    use SingletonTrait;
    ...
    private static function make() : self{
        ...
        return new self(XMultiVersionItemTypeDictionary::getInstance(), $simpleMappings, $complexMappings);
    }

    /**
     * @param XMultiVersionItemTypeDictionary $dictionary
     ...
     */
    public function __construct(XMultiVersionItemTypeDictionary $dictionary, array $simpleMappings, array $complexMappings){
